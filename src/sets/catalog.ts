...
// Newest first. Play Booster sets only: from Murders at Karlov Manor (2024) on,
// every main set ships 30-pack Play Booster displays.
export const CATALOG: CatalogEntry[] = [
  ...
  { code: "fdn", name: "Foundations", releasedAt: "2024-11-15", packsPerBox: 30, boxEstimate: 130 },
  { code: "dsk", name: "Duskmourn: House of Horror", releasedAt: "2024-09-27", packsPerBox: 30, boxEstimate: 125 },
  { code: "blb", name: "Bloomburrow", releasedAt: "2024-08-02", packsPerBox: 30, boxEstimate: 140 },
];
